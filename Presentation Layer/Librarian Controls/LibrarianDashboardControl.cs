...
namespace Library_Juggle.Presentation_Layer.Librarian_Controls
{
    public partial class LibrarianDashboardControl : UserControl
    {
        ...
        private void CheckUserList_Click(object sender, System.EventArgs e)
        {
        ...
        private void AddNewBook_Click(object sender, System.EventArgs e)
        {
            LibrarianDashboardPanel.Controls.Clear();
        ...
        private void GiveBookLoan_Click(object sender, System.EventArgs e)
        {
            LibrarianDashboardPanel.Controls.Clear();
